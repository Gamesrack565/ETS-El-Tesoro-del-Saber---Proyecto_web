...
const MallaCurricular = () => {
  ...
  const data = {
    IA: {
      ...
      sem4: ["Fundamentos de Inteligencia Artificial", "Probabilidad y Estadística", "Matemáticas Avanzadas para la Ingenieria", "Tecnologías para el Desarrollo de Aplicaciones Web", "Análisis y Diseño de Sistemas", "Procesamiento Digital de Señales"],
